 ...
 */
var cal_dir='http://dojang.nz/ajax/calendar';
(function($, undefined) 
{
	$.fn.extend 
	({
		...
		{	
            ...
            var defaults = 
			{
				...
				ajaxJsonFetch: cal_dir+'cal_events.php?'+token,
				ajaxUiUpdate: cal_dir+'cal_update.php?'+token,
				ajaxEventQuickSave:cal_dir+ 'cal_quicksave.php?'+token,
				ajaxEventDelete: cal_dir+'cal_delete.php?'+token,
				ajaxEventEdit: cal_dir+'cal_edit_update.php?'+token,
				ajaxEventExport: cal_dir+'cal_export.php?'+token,
				ajaxRepeatCheck: cal_dir+'cal_check_rep_events.php?'+token,
				ajaxRetrieveDescription: cal_dir+'cal_description.php?'+token,
				ajaxImport: cal_dir+'importer.php?'+token,
