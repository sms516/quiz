	...
	*/
	class EmbedEmbed
	{
		...
		private $rules = array(
			...
			'youtube.com/watch'      => '<iframe width="100%" height="315" src="https://www.youtube.com/embed/%embed_code%" frameborder="0" allowfullscreen></iframe>',
			'youtu.be'               => '<iframe width="100%" height="315" src="https://www.youtube.com/embed/%embed_code%" frameborder="0" allowfullscreen></iframe>',
			'blip.tv'                => '%embed_code%',
			'vimeo.com'              => '<iframe src="https://player.vimeo.com/video/%embed_code%" width="100%" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>',
