        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form id="edit-form-body">
                ...
                <p>
                	<label>Description: </label>
                	<textarea class="form-control" id="edit_description" rows="6" name="edit_description"></textarea>
                </p>
                <p>
                    <label>Category: </label>
                ...
                <div class="pull-left mr-10">
                	<p>
                    <label>Start Date:</label>
                    <input type="text" name="edit_start_date" class="form-control input-sm" placeholder="Y-M-D" id="startDate_edit">
                    </p>
                </div>
                <div class="pull-left">
                	<p>
                    <label>Start Time:</label>
                    <input type="text" class="form-control input-sm" name="edit_start_time" placeholder="HH:MM" id="startTime_edit">
                    </p>
                </div>
                <div class="clearfix"></div>
                <div class="pull-left mr-10">
                	<p>
                    <label>End Date:</label>
                    <input type="text" class="form-control input-sm" name="edit_end_date" placeholder="Y-M-D" id="endDate_edit">
                    </p>
                </div>
                <div class="pull-left">
                	<p>
                    <label>End Time:</label>
                    <input type="text" class="form-control input-sm" name="edit_end_time" placeholder="HH:MM" id="endTime_edit">
                    </p>
                </div>
                <div class="clearfix"></div>
            </form>
